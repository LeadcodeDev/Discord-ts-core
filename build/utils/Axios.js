...
var Axios = /** @class */ (function () {
    ...
    Axios.prototype.get = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get(url, this.configuration)];
    ...
    Axios.prototype.post = function (url, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post(url, data, this.configuration)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Axios.prototype.put = function (url, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.put(url, data, this.configuration)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Axios.prototype.delete = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.delete(url, this.configuration)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
